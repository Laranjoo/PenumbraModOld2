...
namespace PenumbraMod.Content.Buffs
{
    public class ProjectileSnacther : ModProjectile
    {
        ...
        {
            DisplayName.SetDefault("ProjectileSnacther"); // By default, capitalization in classnames will add spaces to the display name. You can customize the display name here by uncommenting this line.
