    ...
    public class BuffPlayer : ModPlayer
    {
        ...
        public override void DrawEffects(PlayerDrawSet drawInfo, ref float r, ref float g, ref float b, ref float a, ref bool fullBright)
        {
            if (!Player.dead && !Player.active)
            {
                if (lifeRegenDebuff)
                {
                    ...
                    {
                        int dust = Dust.NewDust(drawInfo.Position, Player.width, Player.height, ModContent.DustType<NargaDust>(), Player.velocity.X * 0f, Player.velocity.Y * 0f);
        ...
        public override bool PreKill(double damage, int hitDirection, bool pvp, ref bool playSound, ref bool genGore, ref PlayerDeathReason damageSource)
        {
            ...
            if (melting)
            {
                ...
                if (damage == 10.0 && hitDirection == 0 && damageSource.SourceOtherIndex == 8)
                    damageSource = PlayerDeathReason.ByCustomReason(Player.name + "melted till your bones turned ashes");
            ...
            if (l)
            {
                ...
                if (damage == 10.0 && hitDirection == 0 && damageSource.SourceOtherIndex == 8)
                    damageSource = PlayerDeathReason.ByCustomReason(Player.name + "recieved a low voltage energy");
