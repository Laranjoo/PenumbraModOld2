...
namespace PenumbraMod.Content.Items.MeltedBlaster
{
    ...
    public class OVERCHARGING : ModProjectile
    {
        public override void SetStaticDefaults()
        {
            GameShaders.Armor.GetShaderFromItemId(3526);
            DisplayName.SetDefault("OVERCHARGING"); // By default, capitalization in classnames will add spaces to the display name. You can customize the display name here by uncommenting this line.
        }
        ...
        {
            return new Color(255, 0, 0, 0) * Projectile.Opacity;
        }
        public int t;
        public bool d = false;
        public bool g = false;
    ...
    public class Charging : ModProjectile
    {
        ...
        {
            GameShaders.Armor.GetShaderFromItemId(3526);
            DisplayName.SetDefault("Charging Mode"); // By default, capitalization in classnames will add spaces to the display name. You can customize the display name here by uncommenting this line.
        }
    ...
    public class GunMode : ModProjectile
    {
        public override void SetStaticDefaults()
        {
            GameShaders.Armor.GetShaderFromItemId(3526);
            DisplayName.SetDefault("Gun Mode"); // By default, capitalization in classnames will add spaces to the display name. You can customize the display name here by uncommenting this line.
        }
