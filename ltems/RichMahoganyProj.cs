...
{
    public class RichMahoganyProj : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (Projectile.ai[0] >= 40f)
            {
             ...
             int dust = Dust.NewDust(Projectile.position + Projectile.velocity, Projectile.width, Projectile.height, DustID.RichMahogany, Projectile.oldVelocity.X * 0.2f, Projectile.oldVelocity.Y * 0.2f, Scale: 1.0f);
        ...
        public override void Kill(int timeLeft)
        {
            for (int k = 0; k < 10; k++)
            {
                int dust = Dust.NewDust(Projectile.position + Projectile.velocity, Projectile.width, Projectile.height, DustID.RichMahogany, Projectile.oldVelocity.X * 0.2f, Projectile.oldVelocity.Y * 0.2f);
