...
{
    public class IronScytheProj : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (Projectile.ai[0] >= 40f)
            {
                ...
                if (Projectile.Distance(player.Center) <= projdist)
                {
                    Projectile.Kill();
                    return;
                }
            ...
            int dust = Dust.NewDust(Projectile.position + Projectile.velocity, Projectile.width, Projectile.height, DustID.Iron, Projectile.oldVelocity.X * 0.2f, Projectile.oldVelocity.Y * 0.2f);
