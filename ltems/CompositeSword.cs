    ...
    public class CompositeSwordHold : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            {//Adjust when facing the other direction
                ...
                Projectile.rotation = Vector2.Normalize(Main.player[Projectile.owner].Center - Projectile.Center).ToRotation() + MathHelper.ToRadians(86f) + projOwner.velocity.X / -80;
            }
            else
            {

                Projectile.rotation = Vector2.Normalize(Main.player[Projectile.owner].Center - Projectile.Center).ToRotation() + MathHelper.ToRadians(366f) + projOwner.velocity.X / -80;
            }
