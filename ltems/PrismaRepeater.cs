...
namespace PenumbraMod.Content.Items
{
    ...
    public class PrismShot : ModProjectile
    {
        ...
        // this was supposed to move but doesnt but gave it a cool glow effect
        ...
        private Color StripColors(float progressOnStrip)
        {
            ...
            Color result = Color.Lerp(Color.Lerp(Main.DiscoColor,  Color.White, transitToDark * 0.5f), Main.DiscoColor, lerpValue) * (1f - Utils.GetLerpValue(0f, 0.98f, progressOnStrip));
            result.A /= 8;
            return result;
        }
        ...
        private float StripWidth(float progressOnStrip)
        {
            ...
            return MathHelper.Lerp(12f, 24f, num);
        }
        public override void AI()
        {
            Projectile.rotation = Projectile.velocity.ToRotation();
