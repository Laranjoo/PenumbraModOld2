...
namespace PenumbraMod.Content.Items
{
    public class PhantomDarkMatter : ModProjectile
    {
        ...
        {
            Color result = Color.Lerp(Color.Gray, Color.DarkGray, Utils.GetLerpValue(0f, 0.7f, progressOnStrip, clamped: true)) * (1f - Utils.GetLerpValue(0f, 0.98f, progressOnStrip));
            result.A /= 2;
            return result;
        }
