...
namespace PenumbraMod.Content.Items.Armors
{
    ...
    public class PrismHelm : ModItem
    {
        ...
        {
            if (Main.dayTime && player.ownedProjectileCounts[ModContent.ProjectileType<PrismAura>()] < 1 && player.ownedProjectileCounts[ModContent.ProjectileType<Eyeglow>()] < 1)
            {
            ...
            player.setBonus = "Grants the ability to change form during day/night\n" +
                "When its day, your defense is increased by 3, and you have an damaging aura to hurt enemies (Doesn't work on underground), and deal more damage\n" +
                "The aura inflict prismatic lightining on enemies, causing extra damage on them, and increases reaper energy for you\n" +
                "When its night, you do not gain extra defense, and you deal less damage, but when you get hit, enemies also get hit\n" +
