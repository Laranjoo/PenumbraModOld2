...
namespace PenumbraMod.Content.Items
{
	public class TwistedSwing : ModProjectile
	{
        ...
        public override void ModifyHitNPC(NPC target, ref int damage, ref float knockback, ref bool crit, ref int hitDirection)
        {
            ...
            int basic = Projectile.NewProjectile(Projectile.InheritSource(Projectile), target.Center + pos, pos / -4, ProjectileID.SuperStarSlash, damage + (target.life / 30), knockback, Main.player[Projectile.owner].whoAmI);
