...
namespace PenumbraMod.Content.Items
{
    public class MeltedScythe : ModItem
    {
        ...
        {
            if (player.GetModPlayer<ReaperClassDPlayer>().ReaperEnergy > 9400)
            {
        ...
        public override void ModifyHitNPC(Player player, NPC target, ref int damage, ref float knockBack, ref bool crit)
        {
            ...
            if (crit == true)
            {
                ...
                Projectile.NewProjectile(target.GetSource_FromAI(), target.position, newVelocity, ModContent.ProjectileType<MeltedShotEx>(), 50, 12, player.whoAmI);
            }
        }
