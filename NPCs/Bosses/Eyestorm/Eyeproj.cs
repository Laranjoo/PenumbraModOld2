...
namespace PenumbraMod.Content.NPCs.Bosses.Eyestorm
{
    ...
    public class LightningA : ModProjectile
    {
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            if (a < 40)
            {
                Main.EntitySpriteDraw(texture, Projectile.Center, null, Color.White, Projectile.rotation, new Vector2(texture.Width / 2, texture.Height / 2), 1, SpriteEffects.None, 0);
            }
            return true;
        }
        Vector2 hlende = Vector2.Zero;
