...
{
	public class MarshmellowChair : ModTile
	{
		...
		public override void SetStaticDefaults() {
			...
			// Names
			AddMapEntry(new Color(180, 180, 180), Language.GetText("MapObject.Chair"));
		...
		public override void MouseOver(int i, int j) {
			...
			player.cursorItemIconID = ModContent.ItemType<Items.Placeable.Furniture.MarshmellowChair>();
